                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <a href="manage-categories.php">
                                <div class="col-lg-4 col-md-4 col-sm-6" >
                                    <div class="card-box widget-box-one" style="background-color:  #ffb3ff">
                            ...
                            <a href="manage-subcategories.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one" style="background-color:palegreen;">
                            ...
                            <a href="manage-posts.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one" style="background-color: #ffcce6;">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                        ...
                        <div class="row">
                            ...
                            <a href="trash-posts.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one" style="background-color: #00ff80;">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
